        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white leading-tight">
                    {{ app()->getLocale() === 'ar' ? 'تعديل المسمى الوظيفي' : 'Edit Job Title' }}
                </h1>
                <p class="text-sm text-slate-500 mt-1">{{ app()->getLocale() === 'ar' ? $jobTitle->name_ar : $jobTitle->name_en }}</p>
            </div>
        </div>
    </x-slot>

    <form method="POST" action="{{ route('job-titles.update', $jobTitle) }}" class="space-y-6 max-w-4xl mx-auto">
        @csrf
        @method('PUT')
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name_ar" value="{{ old('name_ar', $jobTitle->name_ar) }}" class="erp-input w-full" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="name_en" value="{{ old('name_en', $jobTitle->name_en) }}" class="erp-input w-full" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description_ar" class="erp-input w-full" rows="3">{{ old('description_ar', $jobTitle->description_ar) }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description_en" class="erp-input w-full" rows="3">{{ old('description_en', $jobTitle->description_en) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="level" value="{{ old('level', $jobTitle->level) }}" class="erp-input w-full md:w-1/2">
