    ...
    <form method="POST" action="{{ route('employees.store') }}" class="space-y-6">
        ...
        <div class="erp-card bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="first_name_ar" value="{{ old('first_name_ar') }}" class="erp-input w-full" required>
                ...
                <div>
                    ...
                    <input type="text" name="last_name_ar" value="{{ old('last_name_ar') }}" class="erp-input w-full" required>
                ...
                <div>
                    ...
                    <input type="text" name="first_name_en" value="{{ old('first_name_en') }}" class="erp-input w-full" required>
                ...
                <div>
                    ...
                    <input type="text" name="last_name_en" value="{{ old('last_name_en') }}" class="erp-input w-full" required>
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="erp-input w-full" required>
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" class="erp-input w-full">
        ...
        <div class="erp-card bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="hire_date" value="{{ old('hire_date') }}" class="erp-input w-full">
        ...
        <div class="erp-card bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" name="base_salary" value="{{ old('base_salary') }}" class="erp-input w-full">
        ...
        <div class="flex items-center justify-end gap-4 sticky bottom-6 bg-white dark:bg-slate-900 p-4 border border-slate-200 dark:border-slate-800 shadow-xl rounded-xl">
            ...
            <button type="submit" class="btn-primary px-8 py-2.5 shadow-md hover:shadow-lg transition-shadow">
                {{ app()->getLocale() === 'ar' ? 'حفظ الموظف' : 'Save Employee' }}
            </button>
        </div>
    </form>
</x-app-layout>
