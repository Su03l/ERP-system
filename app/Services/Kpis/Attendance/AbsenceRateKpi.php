...
class AbsenceRateKpi implements KpiResolver
{
    use ResolvesKpiResults;

    public function definition(): KpiDefinition
    {
        return $this->definitionFor('attendance.absence_rate', 'attendance', 'معدل الغياب', 'Absence rate', 'attendance.view');
    }
    ...
    public function resolve(Company $company, KpiDateRange $dateRange): KpiResult
    {
        ...
        $value = $this->percentage($absent, $total);
